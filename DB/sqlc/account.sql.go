...
const createAccout = `-- name: CreateAccout :one
...
type CreateAccoutParams struct {
	Owner    string `json:"owner"`
	Balance  int64  `json:"balance"`
	Currency string `json:"currency"`
}

func (q *Queries) CreateAccout(ctx context.Context, arg CreateAccoutParams) (Account, error) {
	row := q.queryRow(ctx, q.createAccoutStmt, createAccout, arg.Owner, arg.Balance, arg.Currency)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
